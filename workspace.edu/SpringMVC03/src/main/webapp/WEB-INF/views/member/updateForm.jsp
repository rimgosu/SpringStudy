		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="${contextPath }/update.do" method="post">
					...
					<!-- 이 친구가 넘어갈 예정임. -->
					<input required type="hidden" name="memPassword" id="memPassword" value="">
					<input required type="hidden" name="memId" id="memId" value="${member.memId}">
					...
					<table style="text-align: center; border: 1px solid #dddddd"
						...
						<tr>
							...
							<td colspan="2"><input required type="number" name="memAge"
								...
								<div class="form-group"
									...
									<div class="btn-group" data-toggle="buttons">
										...
										<c:if test="${member.memGender eq '남자'}">
											<!-- 라디오를 버튼식으로  -->
											<label class="btn btn-primary active"> <input required
												type="radio" id="memGender" name="memGender"
												autocomplete="off" value="남자" checked="checked"> 남자
											</label> <label class="btn btn-primary"> <input required type="radio"
										...
										<c:if test="${member.memGender eq '여자'}">
											<!-- 라디오를 버튼식으로  -->
											<label class="btn btn-primary "> <input required
												type="radio" id="memGender" name="memGender"
												autocomplete="off" value="남자" > 남자
											</label> <label class="btn btn-primary active"> <input required type="radio"
												id="memGender" name="memGender" autocomplete="off" value="여자" checked="checked">
												여자
											</label>
						...
						<tr>
							...
							<td colspan="2"><input required required type="email" name="memEmail"
						...
						<tr>
							<td colspan="3"><span id="passMessage" style="color: red;"></span>
								...
								<input required type="submit" class="btn btn-primary btn-sm pull-right"
								value="회원정보수정"> <input required type="reset"
